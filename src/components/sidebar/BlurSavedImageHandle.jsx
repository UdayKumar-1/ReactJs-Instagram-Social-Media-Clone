...
function BlurSavedImageHandle({ setBlurForm, item,postState }) {
  ...
  return (
    <>
      <form className={`${postState ? "FormTagProfile" : "FormTag savedPostWidth"}`}>
        <ToastContainer />
...
export default BlurSavedImageHandle;
